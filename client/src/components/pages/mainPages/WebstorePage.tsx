...
import { CartProvider } from "./webstorePageComponents/webstorePageLogic/CartContext";
import { CartDialog } from "./webstorePageComponents/CartDialog";
        ...
        <div className="mt-20 z-0 flex flex-col items-center justify-start gap-6 w-full max-w-6xl mx-auto pb-8">
          ...
          <div className="flex flex-col gap-5 w-full">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              {/* Right side: coins display, admin create, cart */}
